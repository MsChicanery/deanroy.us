                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                            ...
                            <div className="flex space-x-4 mb-6">
                                <a href="#" className="text-black hover:text-black transition-colors transform hover:scale-110">
                                ...
                                <a href="#" className="text-black hover:text-black transition-colors transform hover:scale-110">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M17.7512 2H20.818L14.1179 10.4718L22 22H15.8284L10.9946 15.0082L5.46359 22H2.39494L9.5613 12.9385L2 2H8.32828L12.6976 8.39077L17.7512 2ZM16.6748 19.9692H18.3742L7.4049 3.9241H5.58133L16.6748 19.9692Z"/>
                                    </svg>
                                </a>
                                <a href="#" className="text-black hover:text-black transition-colors transform hover:scale-110">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
